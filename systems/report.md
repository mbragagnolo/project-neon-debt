...
| level_at_boss | thorough | p50 | 6 to 6 | 7 | MISS |
...
- level_at_boss for thorough: a thorough player finishes at 6 and level 7 stays out of reach
...
Hits landed per run, by enemy: scav: utility_blade 56, pipe_wrench 26, breaker_maul 22; drone: utility_blade 32, breaker_maul 14, pipe_wrench 3; landlord: breaker_maul 9, overload 1; riot: breaker_maul 8, overload 6, pipe_wrench 5; elite_scav: overload 1, breaker_maul 1.
...
Hits landed per run, by enemy: scav: utility_blade 50, pipe_wrench 26; drone: utility_blade 28, pipe_wrench 3, breaker_maul 2; landlord: breaker_maul 9, overload 1; riot: breaker_maul 7, pipe_wrench 5, overload 5; elite_scav: overload 1, breaker_maul 1.
...
Hits landed per run, by enemy: scav: utility_blade 18, pipe_wrench 16, breaker_maul 5; drone: utility_blade 18, breaker_maul 3, pipe_wrench 2; riot: breaker_maul 10, pipe_wrench 5; landlord: breaker_maul 10; elite_scav: breaker_maul 2.
...
| boss_attempts | 1 | 1 | 1 | 1 |
| hits_taken | 22 | 26 | 30 | 26 |
| minutes | 29 | 29 | 29 | 29 |
| rooms_visited | 29 | 29 | 29 | 29 |
| farm ratio (XP earned over the district's 947) | | 1.14 | | |
| stall affordable by the last hub visit | | 100% | | |

Deaths per run by room: armory 0.00.
...
Hits landed per run, by enemy: scav: utility_blade 56, pipe_wrench 26, breaker_maul 0; drone: utility_blade 26, breaker_maul 5, pipe_wrench 3; landlord: breaker_maul 9, overload 1; riot: breaker_maul 7, pipe_wrench 5, overload 5; elite_scav: breaker_maul 1, overload 1.
...
### landlord: 240 HP, DEF 4, threshold 16, met at level 5

| weapon | landed | hits | seconds | note |
|---|---|---|---|---|
| breaker_maul | 25 | 10 | 11.4 | stagger |
| utility_blade | 4 | 60 | 20.4 |  |
| pipe_wrench | 9 | 27 | 16.4 |  |
| nailgun | 1 | 240 | 59.8 | 240 energy |
| rivet_gun | 20 | 12 | 18.3 | stagger, 36 energy |
| zipgun | 6 | 40 | 26.0 | 40 energy |
| overload (hack) | 20 | 12 | | 3 RAM each, stagger |

## Hits to die

The player's HP at the level each enemy is met, against that enemy's hits: bare, and with every piece of gear worn (DEF 5, +10 HP). Contact is attack power x 0.5.

| enemy | level met | player HP bare / geared | hit bare / geared | hits to die bare / geared | contact hits to die bare |
|---|---|---|---|---|---|
| scav | 1 | 40 / 50 | 6 / 1 | 7 / 50 | 14 |
| elite_scav | 5 | 60 / 70 | 9 / 4 | 7 / 18 | 15 |
| drone | 2 | 45 / 55 | 5 / 1 | 9 / 55 | 23 |
| riot | 3 | 50 / 60 | 10 / 5 | 5 / 12 | 10 |
| landlord | 5 | 60 / 70 | 14 / 9 | 5 / 8 | 9 |
